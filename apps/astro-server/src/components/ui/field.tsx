...
function FieldGroup({
	...
	return (
		<div
			...
			className={cn(styles.group, className, FieldGroupVariants({ gap }))}
			{...props}
		/>
	);
}
...
const fieldVariants = cva(styles.field, {
	variants: {
		orientation: {
			vertical: styles.field_vertical,
			horizontal: styles.field_horizontal,
			responsive: styles.field_responsive,
		},
	},
	defaultVariants: {
